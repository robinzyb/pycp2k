...
from ._mp2_info6 import _mp2_info6
from ._direct_canonical6 import _direct_canonical6
...
from ._ri_laplace6 import _ri_laplace6
from ._im_time18 import _im_time18
...
class _wf_correlation6(InputSection):
    def __init__(self):
        ...
        self.Do_svd = None
        self.Eps_svd = None
        self.MP2_INFO = _mp2_info6()
        self.DIRECT_CANONICAL = _direct_canonical6()
        self.WFC_GPW = _wfc_gpw6()
        self.RI_MP2 = _ri_mp26()
        self.OPT_RI_BASIS = _opt_ri_basis6()
        self.RI_RPA = _ri_rpa6()
        self.RI_LAPLACE = _ri_laplace6()
        self.IM_TIME = _im_time18()
        self.CPHF = _cphf6()
