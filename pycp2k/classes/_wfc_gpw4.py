...
class _wfc_gpw4(InputSection):
    def __init__(self):
        ...
        self._name = "WFC_GPW"
        self._keywords = {'Eps_grid': 'EPS_GRID', 'Eps_filter': 'EPS_FILTER', 'Cutoff': 'CUTOFF', 'Rel_cutoff': 'REL_CUTOFF', 'Print_level': 'PRINT_LEVEL', 'Eps_pgf_orb_s': 'EPS_PGF_ORB_S', 'Size_lattice_sum': 'SIZE_LATTICE_SUM'}
